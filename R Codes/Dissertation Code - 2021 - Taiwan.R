#+++++++Dissertation++++++++####
#Political Trust in Post-Authoritarian Democracies: 
#Institutional Performance and Cultural Values in the Taiwan, 2001-2020#
#++++++August 15, 2021+++++++####
...
#+++++++++Wave1+++++++####
Wave1 <- read_sav("Taiwan_Wave1.sav")
#View(Wave1)
...
'
Wave1$TrustElecComm <-Wave1$q017
Wave1$TrustElecComm[Wave1$ElecComm>4]<-NA

Wave1$TrustLGU<-Wave1$q014
Wave1$TrustLGU[Wave1$TrustLGU>4]
'
...
'
#public institutions
Wave1$TrustNewsP<-Wave1$q015
Wave1$TrustNewsP[Wave1$TrustNewsP>4]<-NA

Wave1$TrustTV<-Wave1$q016
Wave1$TrustTV[Wave1$TrustTV>4]<-NA

Wave1$TrustNGOs<-Wave1$q018
Wave1$TrustNGOs[Wave1$TrustNGOs>4]<-NA
'
...
#democratic support
Wave1$DemSupport <-Wave1$q103
Wave1$DemSupport[Wave1$DemSupport>10]<-NA
table(Wave1$DemSupport)
'

#demographic controls####

Wave1$SurveyYear <-2001
...
'
Wave1$Ethnicity <-Wave1$se016
table(Wave1$Ethnicity)
'
#Ethnicity. What is your father’s ethnicity? Minnan=1, Hakka=2, mainlander=3.
#as used by  Tsai 2017 in Achen and Wang 2017

#Construct indexes####
#index of political trust####

Wave1$PolTrust<-rowMeans(cbind(Wave1$TrustCourts,Wave1$TrustNatGov,Wave1$TrustCongress,Wave1$TrustParties,
                               Wave1$TrustMilitary,Wave1$TrustPolice,
                               Wave1$TrustCivService,Wave1$TrustLGU, Wave1$TrustElecComm,
                               Wave1$TrustNewsP,Wave1$TrustTV,Wave1$TrustNGOs),na.rm=TRUE)
...
Wave1$IndexTrustNationalInst<-rowMeans(cbind(Wave1$TrustCourts,Wave1$TrustNatGov,Wave1$TrustCongress,Wave1$TrustParties),na.rm=TRUE)
summary(Wave1$IndexTrustNationalInst)

#Trust in civil institutions
Wave1$IndexTrustCivilInst<-rowMeans(cbind(Wave1$TrustCivService,Wave1$TrustLGU, Wave1$TrustElecComm),na.rm=TRUE)
summary(Wave1$IndexTrustCivilInst)

#Trust in protective institutions
Wave1$IndexTrustProtectInst<-rowMeans(cbind(Wave1$TrustMilitary,Wave1$TrustPolice),na.rm=TRUE)
summary(Wave1$IndexTrustProtectInst)

#Trust in public institutions
Wave1$IndexTrustPublicInst<-rowMeans(cbind(Wave1$TrustNewsP,Wave1$TrustTV,Wave1$TrustNGOs),na.rm=TRUE)
summary(Wave1$IndexTrustPublicInst)
...
'
#regressions####
summary(Wave1.Mod1 <-lm(PolTrust~Inst.performance + Trad.Values + Demo.Values + AuthoritarianValues+
                    SocialTrust + PolInterest + DemSatisfaction+
                    RegimeSatisfaction+ Age + Gender +IncomeGroup+
                    Religiosity + Urbanization +  Education + Ethnicity ,data = Wave1 ))

summary(Wave1.Mod2 <-lm(PolTrust~Inst.performance*Trad.Values + Demo.Values + AuthoritarianValues+
                    SocialTrust + PolInterest + DemSatisfaction+
                    RegimeSatisfaction+ Age + Gender +IncomeGroup+
                    Religiosity + Urbanization +  Education,data = Wave1 ))

summary(Wave1.Mod3 <-lm(PolTrust~Inst.performance*DemSatisfaction + Trad.Values + Demo.Values + AuthoritarianValues+
                    SocialTrust + PolInterest +
                    RegimeSatisfaction+ Age + Gender +IncomeGroup+
                    Religiosity + Urbanization +  Education ,data = Wave1 ))

summary(Wave1.Mod4 <-lm(PolTrust~Inst.performance + Trad.Values*DemSatisfaction + Demo.Values + AuthoritarianValues+
                    SocialTrust + PolInterest +
                    RegimeSatisfaction+ Age + Gender +IncomeGroup+
                    Religiosity + Urbanization +  Education ,data = Wave1 ))

summary(Wave1.Mod5 <-lm(PolTrust~Inst.performance + Trad.Values*Demo.Values*AuthoritarianValues+
                    SocialTrust + PolInterest +DemSatisfaction+
                    RegimeSatisfaction+ Age + Gender +IncomeGroup+
                    Religiosity + Urbanization +  Education,data = Wave1 ))

summary(Wave1.Mod6 <-lm(PolTrust~Inst.performance*Demo.Values*AuthoritarianValues+Trad.Values+
                    SocialTrust + PolInterest +DemSatisfaction+
                    RegimeSatisfaction+ Age + Gender +IncomeGroup+
                    Religiosity + Urbanization +  Education,data = Wave1 ))

summary(Wave1.Mod7 <-lm(PolTrust~Inst.performance*DemSatisfaction*RegimeSatisfaction + Trad.Values+ 
                    Demo.Values+AuthoritarianValues+
                    SocialTrust + PolInterest +  Age + Gender +IncomeGroup +
                    Religiosity + Urbanization +  Education , data = Wave1 ))

summary(Wave1.Mod8 <-lm(PolTrust~Inst.performance + Trad.Values*DemSatisfaction*RegimeSatisfaction + 
                    Demo.Values+AuthoritarianValues+
                    SocialTrust + PolInterest +  Age + Gender +IncomeGroup +
                    Religiosity + Urbanization +  Education , data = Wave1 ))

library(stargazer)
stargazer(Wave1.Mod1, Wave1.Mod2, Wave1.Mod3, Wave1.Mod4, type="html", title="Taiwan_Wave1_Table1", out = "Taiwan_Wave1_Table1.htm")
stargazer(Wave1.Mod5, Wave1.Mod6, Wave1.Mod7, Wave1.Mod8, type="html", title="Taiwan_Wave1_Table2", out = "Taiwan_Wave1_Table2.htm")
'
...
Wave2<-read_sav("Taiwan_Wave2.sav")
#View(Wave2)
...
'
#democratic support
Wave2$DemSupport <-Wave2$q103
Wave2$DemSupport[Wave2$DemSupport>10]<-NA
table(Wave2$DemSupport)
Wave2$q103
'
...
'
#regressions####
summary(Wave2.Mod1 <-lm(PolTrust~Inst.performance + Trad.Values + Demo.Values + AuthoritarianValues+
                    SocialTrust + PolInterest + DemSatisfaction+
                    RegimeSatisfaction+ Age + Gender +IncomeGroup+
                    Religiosity + Urbanization +  Education ,data = Wave2 ))

summary(Wave2.Mod2 <-lm(PolTrust~Inst.performance*Trad.Values + Demo.Values + AuthoritarianValues+
                    SocialTrust + PolInterest + DemSatisfaction+
                    RegimeSatisfaction+ Age + Gender +IncomeGroup+
                    Religiosity + Urbanization +  Education,data = Wave2 ))

summary(Wave2.Mod3 <-lm(PolTrust~Inst.performance*DemSatisfaction + Trad.Values + Demo.Values + AuthoritarianValues+
                    SocialTrust + PolInterest +
                    RegimeSatisfaction+ Age + Gender +IncomeGroup+
                    Religiosity + Urbanization +  Education ,data = Wave2 ))

summary(Wave2.Mod4 <-lm(PolTrust~Inst.performance + Trad.Values*DemSatisfaction + Demo.Values + AuthoritarianValues+
                    SocialTrust + PolInterest +
                    RegimeSatisfaction+ Age + Gender +IncomeGroup+
                    Religiosity + Urbanization +  Education ,data = Wave2 ))

summary(Wave2.Mod5 <-lm(PolTrust~Inst.performance + Trad.Values*Demo.Values*AuthoritarianValues+
                    SocialTrust + PolInterest +DemSatisfaction+
                    RegimeSatisfaction+ Age + Gender +IncomeGroup+
                    Religiosity + Urbanization +  Education,data = Wave2 ))

summary(Wave2.Mod6 <-lm(PolTrust~Inst.performance*Demo.Values*AuthoritarianValues+Trad.Values+
                    SocialTrust + PolInterest +DemSatisfaction+
                    RegimeSatisfaction+ Age + Gender +IncomeGroup+
                    Religiosity + Urbanization +  Education,data = Wave2 ))

summary(Wave2.Mod7 <-lm(PolTrust~Inst.performance*DemSatisfaction*RegimeSatisfaction + Trad.Values+ 
                    Demo.Values+AuthoritarianValues+
                    SocialTrust + PolInterest +  Age + Gender +IncomeGroup +
                    Religiosity + Urbanization +  Education , data = Wave2 ))

summary(Wave2.Mod8 <-lm(PolTrust~Inst.performance + Trad.Values*DemSatisfaction*RegimeSatisfaction + 
                    Demo.Values+AuthoritarianValues+
                    SocialTrust + PolInterest +  Age + Gender +IncomeGroup +
                    Religiosity + Urbanization +  Education , data = Wave2 ))
library(stargazer)
stargazer(Wave2.Mod1, Wave2.Mod2, Wave2.Mod3, Wave2.Mod4, type="html", title="Taiwan_Wave2_Table1", out = "Taiwan_Wave2_Table1.htm")
stargazer(Wave2.Mod5, Wave2.Mod6, Wave2.Mod7, Wave2.Mod8, type="html", title="Taiwan_Wave2_Table2", out = "Taiwan_Wave2_Table2.htm")
'
#save a copy####
write.dta(Wave2, file="TaiwanWave2_2021version.dta")

#+++++++++Wave3+++++++####

Wave3 <- read_sav("Taiwan_Wave3.sav")
#View(Wave3)
...
'
#regressions####
summary(Wave3.Mod1 <-lm(PolTrust~Inst.performance + Trad.Values + Demo.Values + AuthoritarianValues+
                    SocialTrust + PolInterest + DemSatisfaction+
                    RegimeSatisfaction+ Age + Gender +IncomeGroup+
                    Religiosity + Urbanization +  Education ,data = Wave3 ))

summary(Wave3.Mod2 <-lm(PolTrust~Inst.performance*Trad.Values + Demo.Values + AuthoritarianValues+
                    SocialTrust + PolInterest + DemSatisfaction+
                    RegimeSatisfaction+ Age + Gender +IncomeGroup+
                    Religiosity + Urbanization +  Education,data = Wave3 ))

summary(Wave3.Mod3 <-lm(PolTrust~Inst.performance*DemSatisfaction + Trad.Values + Demo.Values + AuthoritarianValues+
                    SocialTrust + PolInterest +
                    RegimeSatisfaction+ Age + Gender +IncomeGroup+
                    Religiosity + Urbanization +  Education ,data = Wave3 ))

summary(Wave3.Mod4 <-lm(PolTrust~Inst.performance + Trad.Values*DemSatisfaction + Demo.Values + AuthoritarianValues+
                    SocialTrust + PolInterest +
                    RegimeSatisfaction+ Age + Gender +IncomeGroup+
                    Religiosity + Urbanization +  Education ,data = Wave3 ))

summary(Wave3.Mod5 <-lm(PolTrust~Inst.performance + Trad.Values*Demo.Values*AuthoritarianValues+
                    SocialTrust + PolInterest +DemSatisfaction+
                    RegimeSatisfaction+ Age + Gender +IncomeGroup+
                    Religiosity + Urbanization +  Education,data = Wave3 ))

summary(Wave3.Mod6 <-lm(PolTrust~Inst.performance*Demo.Values*AuthoritarianValues+Trad.Values+
                    SocialTrust + PolInterest +DemSatisfaction+
                    RegimeSatisfaction+ Age + Gender +IncomeGroup+
                    Religiosity + Urbanization +  Education,data = Wave3 ))

summary(Wave3.Mod7 <-lm(PolTrust~Inst.performance*DemSatisfaction*RegimeSatisfaction + Trad.Values+ 
                    Demo.Values+AuthoritarianValues+
                    SocialTrust + PolInterest +  Age + Gender +IncomeGroup +
                    Religiosity + Urbanization +  Education , data = Wave3 ))

summary(Wave3.Mod8 <-lm(PolTrust~Inst.performance + Trad.Values*DemSatisfaction*RegimeSatisfaction + 
                    Demo.Values+AuthoritarianValues+
                    SocialTrust + PolInterest +  Age + Gender +IncomeGroup +
                    Religiosity + Urbanization +  Education , data = Wave3 ))
library(stargazer)
stargazer(Wave3.Mod1, Wave3.Mod2, Wave3.Mod3, Wave3.Mod4, type="html", title="Taiwan_Wave3_Table1", out = "Taiwan_Wave3_Table1.htm")
stargazer(Wave3.Mod5, Wave3.Mod6, Wave3.Mod7, Wave3.Mod8, type="html", title="Taiwan_Wave3_Table2", out = "Taiwan_Wave3_Table2.htm")
'
#save a copy####
write.dta(Wave3, file="TaiwanWave3_2021version.dta")

#+++++++++Wave4+++++++####

Wave4 <-read_sav("Taiwan_Wave4.sav")
#View(Wave4)
...
'#regressions####
summary(Wave4.Mod1 <-lm(PolTrust~Inst.performance + Trad.Values + Demo.Values + AuthoritarianValues+
                    SocialTrust + PolInterest + DemSatisfaction+
                    RegimeSatisfaction+ Age + Gender +IncomeGroup+
                    Religiosity + Urbanization +  Education ,data = Wave4 ))

summary(Wave4.Mod2 <-lm(PolTrust~Inst.performance*Trad.Values + Demo.Values + AuthoritarianValues+
                    SocialTrust + PolInterest + DemSatisfaction+
                    RegimeSatisfaction+ Age + Gender +IncomeGroup+
                    Religiosity + Urbanization +  Education,data = Wave4 ))

summary(Wave4.Mod3 <-lm(PolTrust~Inst.performance*DemSatisfaction + Trad.Values + Demo.Values + AuthoritarianValues+
                    SocialTrust + PolInterest +
                    RegimeSatisfaction+ Age + Gender +IncomeGroup+
                    Religiosity + Urbanization +  Education ,data = Wave4 ))

summary(Wave4.Mod4 <-lm(PolTrust~Inst.performance + Trad.Values*DemSatisfaction + Demo.Values + AuthoritarianValues+
                    SocialTrust + PolInterest +
                    RegimeSatisfaction+ Age + Gender +IncomeGroup+
                    Religiosity + Urbanization +  Education ,data = Wave4 ))

summary(Wave4.Mod5 <-lm(PolTrust~Inst.performance + Trad.Values*Demo.Values*AuthoritarianValues+
                    SocialTrust + PolInterest +DemSatisfaction+
                    RegimeSatisfaction+ Age + Gender +IncomeGroup+
                    Religiosity + Urbanization +  Education,data = Wave4 ))

summary(Wave4.Mod6 <-lm(PolTrust~Inst.performance*Demo.Values*AuthoritarianValues+Trad.Values+
                    SocialTrust + PolInterest +DemSatisfaction+
                    RegimeSatisfaction+ Age + Gender +IncomeGroup+
                    Religiosity + Urbanization +  Education,data = Wave4 ))

summary(Wave4.Mod7 <-lm(PolTrust~Inst.performance*DemSatisfaction*RegimeSatisfaction + Trad.Values+ 
                    Demo.Values+AuthoritarianValues+
                    SocialTrust + PolInterest +  Age + Gender +IncomeGroup +
                    Religiosity + Urbanization +  Education , data = Wave4 ))

summary(Wave4.Mod8 <-lm(PolTrust~Inst.performance + Trad.Values*DemSatisfaction*RegimeSatisfaction + 
                    Demo.Values+AuthoritarianValues+
                    SocialTrust + PolInterest +  Age + Gender +IncomeGroup +
                    Religiosity + Urbanization +  Education , data = Wave4 ))
library(stargazer)
stargazer(Wave4.Mod1, Wave4.Mod2, Wave4.Mod3, Wave4.Mod4, type="html", title="Taiwan_Wave4_Table1", out = "Taiwan_Wave4_Table1.htm")
stargazer(Wave4.Mod5, Wave4.Mod6, Wave4.Mod7, Wave4.Mod8, type="html", title="Taiwan_Wave4_Table2", out = "Taiwan_Wave4_Table2.htm")
'
#save a copy####
write.dta(Wave4, file="TaiwanWave4_2021version.dta")

#+++++++++Wave5+++++++####

Wave5 <-read_dta("Taiwan_Wave5.dta")
#View(Wave5)
...
'
#regressions####
summary(Wave5.Mod1 <-lm(PolTrust~Inst.performance + Trad.Values + Demo.Values + AuthoritarianValues+
                    SocialTrust + PolInterest + DemSatisfaction+
                    RegimeSatisfaction+ Age + Gender +IncomeGroup+
                    Religiosity + Urbanization +  Education ,data = Wave5 ))

summary(Wave5.Mod2 <-lm(PolTrust~Inst.performance*Trad.Values + Demo.Values + AuthoritarianValues+
                    SocialTrust + PolInterest + DemSatisfaction+
                    RegimeSatisfaction+ Age + Gender +IncomeGroup+
                    Religiosity + Urbanization +  Education,data = Wave5 ))

summary(Wave5.Mod3 <-lm(PolTrust~Inst.performance*DemSatisfaction + Trad.Values + Demo.Values + AuthoritarianValues+
                    SocialTrust + PolInterest +
                    RegimeSatisfaction+ Age + Gender +IncomeGroup+
                    Religiosity + Urbanization +  Education ,data = Wave5 ))

summary(Wave5.Mod4 <-lm(PolTrust~Inst.performance + Trad.Values*DemSatisfaction + Demo.Values + AuthoritarianValues+
                    SocialTrust + PolInterest +
                    RegimeSatisfaction+ Age + Gender +IncomeGroup+
                    Religiosity + Urbanization +  Education ,data = Wave5 ))

summary(Wave5.Mod5 <-lm(PolTrust~Inst.performance + Trad.Values*Demo.Values*AuthoritarianValues+
                    SocialTrust + PolInterest +DemSatisfaction+
                    RegimeSatisfaction+ Age + Gender +IncomeGroup+
                    Religiosity + Urbanization +  Education,data = Wave5 ))

summary(Wave5.Mod6 <-lm(PolTrust~Inst.performance*Demo.Values*AuthoritarianValues+Trad.Values+
                    SocialTrust + PolInterest +DemSatisfaction+
                    RegimeSatisfaction+ Age + Gender +IncomeGroup+
                    Religiosity + Urbanization +  Education,data = Wave5 ))

summary(Wave5.Mod7 <-lm(PolTrust~Inst.performance*DemSatisfaction*RegimeSatisfaction + Trad.Values+ 
                    Demo.Values+AuthoritarianValues+
                    SocialTrust + PolInterest +  Age + Gender +IncomeGroup +
                    Religiosity + Urbanization +  Education , data = Wave5 ))

summary(Wave5.Mod8 <-lm(PolTrust~Inst.performance + Trad.Values*DemSatisfaction*RegimeSatisfaction + 
                    Demo.Values+AuthoritarianValues+
                    SocialTrust + PolInterest +  Age + Gender +IncomeGroup +
                    Religiosity + Urbanization +  Education , data = Wave5 ))

library(stargazer)
stargazer(Wave5.Mod1, Wave5.Mod2, Wave5.Mod3, Wave5.Mod4, type="html", title="Taiwan_Wave5_Table1", out = "Taiwan_Wave5_Table1.htm")
stargazer(Wave5.Mod5, Wave5.Mod6, Wave5.Mod7, Wave5.Mod8, type="html", title="Taiwan_Wave5_Table2", out = "Taiwan_Wave5_Table2.htm")
'
#save a copy####
write.dta(Wave5, file="TaiwanWave5_2021version.dta")
...
#pooled regressions####
summary(Taiwan.Pooled.Mod1 <-lm(PolTrust~Inst.performance + Trad.Values  + AuthoritarianValues+
                           SocialTrust + PolInterest + DemSatisfaction+
                           RegimeSatisfaction+ Age + Gender +IncomeGroup+
                           Religiosity + Urbanization +  Education ,data = merge.final ))

#with insti performance
summary(Taiwan.Pooled.Mod2 <-lm(PolTrust~AuthoritarianValues+ PresentEconEval + RetroEconEval +ProspectEconEval +
                                  PresentFamEcon + RetroFamEcon + ProspectiveFamEcon +
                                  CurbCorruption + NoNatCorruption + NoLocalCorruption ,data = merge.final ))

#with trad values
summary(Taiwan.Pooled.Mod3 <-lm(PolTrust~AuthoritarianValues+ FollowParents + ConflictAvoidance + Passive + FamilyFirst ,data = merge.final ))




'
summary(Taiwan.Pooled.Mod2 <-lm(PolTrust~Inst.performance*Trad.Values + Demo.Values + AuthoritarianValues+
                           SocialTrust + PolInterest + DemSatisfaction+
                           RegimeSatisfaction+ Age + Gender +IncomeGroup+
                           Religiosity + Urbanization +  Education,data = merge.final ))

summary(Taiwan.Pooled.Mod3 <-lm(PolTrust~Inst.performance*DemSatisfaction + Trad.Values + Demo.Values + AuthoritarianValues+
                           SocialTrust + PolInterest +
                           RegimeSatisfaction+ Age + Gender +IncomeGroup+
                           Religiosity + Urbanization +  Education ,data = merge.final ))

summary(Taiwan.Pooled.Mod4 <-lm(PolTrust~Inst.performance + Trad.Values*DemSatisfaction + Demo.Values + AuthoritarianValues+
                           SocialTrust + PolInterest +
                           RegimeSatisfaction+ Age + Gender +IncomeGroup+
                           Religiosity + Urbanization +  Education ,data = merge.final ))

summary(Taiwan.Pooled.Mod5 <-lm(PolTrust~Inst.performance + Trad.Values*Demo.Values*AuthoritarianValues+
                           SocialTrust + PolInterest +DemSatisfaction+
                           RegimeSatisfaction+ Age + Gender +IncomeGroup+
                           Religiosity + Urbanization +  Education,data = merge.final ))

summary(Taiwan.Pooled.Mod6 <-lm(PolTrust~Inst.performance*Demo.Values*AuthoritarianValues+Trad.Values+
                           SocialTrust + PolInterest +DemSatisfaction+
                           RegimeSatisfaction+ Age + Gender +IncomeGroup+
                           Religiosity + Urbanization +  Education,data = merge.final ))

summary(Taiwan.Pooled.Mod7 <-lm(PolTrust~Inst.performance*DemSatisfaction*RegimeSatisfaction + Trad.Values+ 
                           Demo.Values+AuthoritarianValues+
                           SocialTrust + PolInterest +  Age + Gender +IncomeGroup +
                           Religiosity + Urbanization +  Education , data = merge.final ))

summary(Taiwan.Pooled.Mod8 <-lm(PolTrust~Inst.performance + Trad.Values*DemSatisfaction*RegimeSatisfaction + 
                           Demo.Values+AuthoritarianValues+
                           SocialTrust + PolInterest +  Age + Gender +IncomeGroup +
                           Religiosity + Urbanization +  Education , data = merge.final ))
'
...
library(stargazer)
stargazer(Taiwan.Pooled.Mod1, Taiwan.Pooled.Mod2, Taiwan.Pooled.Mod3, Taiwan.Pooled.Mod4, type="html", title="Taiwan_PooledTable1", out = "Taiwan_Pooled_Table1.htm")
stargazer(Taiwan.Pooled.Mod5, Taiwan.Pooled.Mod6, Taiwan.Pooled.Mod7, Taiwan.Pooled.Mod8, type="html", title="Taiwan_PooledTable2", out = "Taiwan_Pooled_Table2.htm")


#output results####

stargazer(Wave1.Mod1, Wave2.Mod1, Wave3.Mod1, 
          Wave4.Mod1, Wave5.Mod1, Taiwan.Pooled.Mod1, type = "html", out = "RegressionTaiwan.htm" )

#save a copy####
write.dta(merge.final, file="merge.final_TaiwanWave5_2021version.dta")

'
#descriptive statistics####
library(psych)
psych::describe(dat1) #wave1
psych::describe(dat2) #wave2
psych::describe(dat3) #wave3
psych::describe(dat4) #wave4
psych::describe(dat5) #wave5
...
Trust=~TrustCourts + TrustNatGov + TrustCongress + TrustParties + TrustMilitary + TrustPolice +TrustCivService 
 #make PolTrust as latent variable of 7 observed trust variables
ACA=~StrongLeaders + ConformitytoLeaders + Submission + AntiPolPluralism1 + AntiPolPluralism2
InsPerf=~PresentEconEval + RetroEconEval + ProspectEconEval + PresentFamEcon + RetroFamEcon + ProspectiveFamEcon

#regression

Trust ~ ACA + InsPerf + NoLocalCorruption + SocialTrust + PolInterest + DemSatisfaction+
                    RegimeSatisfaction+ Age + Gender +IncomeGroup+
                    Religiosity + Urbanization +  Education
"

sem.fit1 <- sem(sem.model1, data = merge.final)
summary(sem.fit1, standardized=TRUE, fit.measures = TRUE)


semPaths(sem.fit1, "std", edge.label.cex = 1.2, 
         fade = FALSE, style = "lisrel",
         title.color = "black")  #plot #standardized para estimates
...
fit1 <- semTable(sem.fit1 , file =
                   file.path(tempdir , "sem.fit1.html"),
                 type = "latex",
                 print.results = FALSE)
