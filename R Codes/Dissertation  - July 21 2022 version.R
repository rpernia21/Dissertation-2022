...
#load data
#WVS6<- read_dta("WV6_Data_stata_v20201117.dta")
WVS7<- read_dta("WVS_Cross-National_Wave_7_stata_v2_0.dta")
...
dat2 <-WVS7 %>% 
  select(B_COUNTRY, B_COUNTRY_ALPHA, W_WEIGHT, pwght, S025,
