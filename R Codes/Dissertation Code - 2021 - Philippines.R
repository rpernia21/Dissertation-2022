...
#Institutional Performance and Cultural Values in the Philippines, 2001-2020#
#++++++August 5, 2021+++++++####
...
stargazer(Wave1.Mod1, Wave1.Mod2, Wave1.Mod3, Wave1.Mod4, type="text")
stargazer(Wave1.Mod5, Wave1.Mod6, Wave1.Mod7, Wave1.Mod8, type="text")
stargazer(Wave1.Mod1, Wave1.Mod2, Wave1.Mod3, Wave1.Mod4, type="html", title="Philippines_Wave1_Table1", out = "Philippines_Wave1_Table1.htm")
stargazer(Wave1.Mod5, Wave1.Mod6, Wave1.Mod7, Wave1.Mod8, type="html", title="Philippines_Wave1_Table2", out = "Philippines_Wave1_Table2.htm")
...
stargazer(Wave2.Mod1, Wave2.Mod2, Wave2.Mod3, Wave2.Mod4, type="text")
stargazer(Wave2.Mod5, Wave2.Mod6, Wave2.Mod7, Wave2.Mod8, type="text")
stargazer(Wave2.Mod1, Wave2.Mod2, Wave2.Mod3, Wave2.Mod4, type="html", title="Philippines_Wave2_Table1", out = "Philippines_Wave2_Table1.htm")
stargazer(Wave2.Mod5, Wave2.Mod6, Wave2.Mod7, Wave2.Mod8, type="html", title="Philippines_Wave2_Table2", out = "Philippines_Wave2_Table2.htm")
...
stargazer(Wave3.Mod1, Wave3.Mod2, Wave3.Mod3, Wave3.Mod4, type="text")
stargazer(Wave3.Mod5, Wave3.Mod6, Wave3.Mod7, Wave3.Mod8, type="text")
stargazer(Wave3.Mod1, Wave3.Mod2, Wave3.Mod3, Wave3.Mod4, type="html", title="Philippines_Wave3_Table1", out = "Philippines_Wave3_Table1.htm")
stargazer(Wave3.Mod5, Wave3.Mod6, Wave3.Mod7, Wave3.Mod8, Wave3.type="html", title="Philippines_Wave3_Table2", out = "Philippines_Wave3_Table2.htm")
...
stargazer(Wave4.Mod1, Wave4.Mod2, Wave4.Mod3, Wave4.Mod4, type="text")
stargazer(Wave4.Mod5, Wave4.Mod6, Wave4.Mod7, Wave4.Mod8, type="text")
stargazer(Wave4.Mod1, Wave4.Mod2, Wave4.Mod3, Wave4.Mod4, type="html", title="Philippines_Wave4_Table1", out = "Philippines_Wave4_Table1.htm")
stargazer(Wave4.Mod5, Wave4.Mod6, Wave4.Mod7, Wave4.Mod8, type="html", title="Philippines_Wave4_Table2", out = "Philippines_Wave4_Table2.htm")
...
library(stargazer)
stargazer(Wave5.Mod1, Wave5.Mod2, Wave5.Mod3, Wave5.Mod4, type="text")
stargazer(Wave5.Mod5, Wave5.Mod6, Wave5.Mod7, Wave5.Mod8, type="text")
stargazer(Wave5.Mod1, Wave5.Mod2, Wave5.Mod3, Wave5.Mod4, type="html", title="Philippines_Wave5_Table1", out = "Philippines_Wave5_Table1.htm")
stargazer(Wave5.Mod5, Wave5.Mod6, Wave5.Mod7, Wave5.Mod8, type="html", title="Philippines_Wave5_Table2", out = "Philippines_Wave5_Table2.htm")
...
#pooled regressions####
summary(Philippines.Pooled.Mod1 <-lm(PolTrust~Inst.performance + Trad.Values + Demo.Values + AuthoritarianValues+
                    SocialTrust + PolInterest + DemSatisfaction+
                    RegimeSatisfaction+ Age + Gender +IncomeGroup+
                    Religiosity + Urbanization +  Education ,data = merge.final ))

summary(Philippines.Pooled.Mod2 <-lm(PolTrust~Inst.performance*Trad.Values + Demo.Values + AuthoritarianValues+
                    SocialTrust + PolInterest + DemSatisfaction+
                    RegimeSatisfaction+ Age + Gender +IncomeGroup+
                    Religiosity + Urbanization +  Education,data = merge.final ))

summary(Philippines.Pooled.Mod3 <-lm(PolTrust~Inst.performance*DemSatisfaction + Trad.Values + Demo.Values + AuthoritarianValues+
                    SocialTrust + PolInterest +
                    RegimeSatisfaction+ Age + Gender +IncomeGroup+
                    Religiosity + Urbanization +  Education ,data = merge.final ))

summary(Philippines.Pooled.Mod4 <-lm(PolTrust~Inst.performance + Trad.Values*DemSatisfaction + Demo.Values + AuthoritarianValues+
                    SocialTrust + PolInterest +
                    RegimeSatisfaction+ Age + Gender +IncomeGroup+
                    Religiosity + Urbanization +  Education ,data = merge.final ))

summary(Philippines.Pooled.Mod5 <-lm(PolTrust~Inst.performance + Trad.Values*Demo.Values*AuthoritarianValues+
                    SocialTrust + PolInterest +DemSatisfaction+
                    RegimeSatisfaction+ Age + Gender +IncomeGroup+
                    Religiosity + Urbanization +  Education,data = merge.final ))

summary(Philippines.Pooled.Mod6 <-lm(PolTrust~Inst.performance*Demo.Values*AuthoritarianValues+Trad.Values+
                    SocialTrust + PolInterest +DemSatisfaction+
                    RegimeSatisfaction+ Age + Gender +IncomeGroup+
                    Religiosity + Urbanization +  Education,data = merge.final ))

summary(Philippines.Pooled.Mod7 <-lm(PolTrust~Inst.performance*DemSatisfaction*RegimeSatisfaction + Trad.Values+ 
                    Demo.Values+AuthoritarianValues+
                    SocialTrust + PolInterest +  Age + Gender +IncomeGroup +
                    Religiosity + Urbanization +  Education , data = merge.final ))

summary(Philippines.Pooled.Mod8 <-lm(PolTrust~Inst.performance + Trad.Values*DemSatisfaction*RegimeSatisfaction + 
                    Demo.Values+AuthoritarianValues+
                    SocialTrust + PolInterest +  Age + Gender +IncomeGroup +
                    Religiosity + Urbanization +  Education , data = merge.final ))
...
library(stargazer)
stargazer(Philippines.Pooled.Mod1, Philippines.Pooled.Mod2, Philippines.Pooled.Mod3, Philippines.Pooled.Mod4, type="html", title="Philippines_PooledTable1", out = "Philippines_Pooled_Table1.htm")
stargazer(Philippines.Pooled.Mod5, Philippines.Pooled.Mod6, Philippines.Pooled.Mod7, Philippines.Pooled.Mod8, type="html", title="Philippines_Pooledable2", out = "Philippines_Pooled_Table2.htm")


#output results####

stargazer(Wave1.Mod1, Wave2.Mod1, Wave3.Mod1, 
          Wave4.Mod1, Wave5.Mod1, Philippines.Pooled.Mod1, type = "html", out = "RegressionPhilippines.htm" )
